...
$stud_b=$_GET['b'];
$stud_c=$_GET['c'];
$query="select sports.sno from stud,registration,sports where stud.sid=registration.sid and sports.sno=registration.sno and sports.sp_name='Boxing';";
...
echo "<b><font color:white size:5>Boxing Winner List</font></br>";
