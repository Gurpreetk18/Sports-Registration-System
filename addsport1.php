...
$q="insert into sports(sp_name,date,time) values('".$name."','".$date."','".$time."');";
$a=mysql_query($q);
if(!$a)
echo mysql_error();
else
...
echo "<table border=1 bgcolor=black><tr><td><font color=white>Sports no</font></td><td><font color=white>Sports name</font></td><td><font color=white>Date</font></td><td><font color=white>Time</font></td></tr>";

while($c=mysql_fetch_array($p))

{
	
	echo "<tr><td><font color=white>".$c[0]."</font></td><td><font color=white>".$c[1]."</font></td><td><font color=white>".$c[2]."</font></td><td><font color=white>".$c[3]."</font></td></tr>";
