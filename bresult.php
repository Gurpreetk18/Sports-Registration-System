...
echo "<html><body>";
echo "<form name=f method=get action=http://localhost/PROJECT/bresult1.php>";

echo "<center><font color=white size=10px>Winner Entry For Badminton</font></center>";
echo "<table align=center bgcolor=black>";



$q=mysql_query("select stud.sname from stud,registration,sports where stud.sid=registration.sid and sports.sno=registration.sno and sports.sp_name='Badminton';");
