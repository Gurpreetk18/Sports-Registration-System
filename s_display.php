...
echo "<h1><b>REGISTERED SPORTS</b></h1>";
$p=mysql_query("select * from sports");
if(!$p)
echo mysql_error();
else
echo "<table border=1 bgcolor=black><tr><td><font color=white><b>Sports no</b></font></td><td><font color=white><b>Sports name</b></font></td><td><font color=white><b>Date</b></font></td><td><font color=white><b>Time</b></font></td></tr>";
while($c=mysql_fetch_array($p))
{
	
	echo "<tr><td><font color=white>".$c[0]."</td><td><font color=white>".$c[1]."</font></td><td><font color=white>".$c[2]."</font></td><td><font color=white>".$c[3]."</font></td></tr>";
