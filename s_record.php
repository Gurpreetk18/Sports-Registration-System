...
$p=mysql_query("select stud.sid,stud.sname,stud.class,dept.d_name from registration,stud,sports,dept where stud.sid=registration.sid and sports.sno=registration.sno and dept.dno=stud.dno and sports.sp_name='Badminton';");
if(!$p)
echo mysql_error();
else
echo "<table border=1 bgcolor=black><tr><td><font color=white>Student id</td><td><font color=white>Student name</td><td><font color=white>Class</td><td><font color=white>Department</td></tr>";
...
$p=mysql_query("select stud.sid,stud.sname,stud.class,dept.d_name from registration,stud,sports,dept where stud.sid=registration.sid and sports.sno=registration.sno and dept.dno=stud.dno and sports.sp_name='Javelin throw';");
if(!$p)
echo mysql_error();
else
echo "<table border=1 bgcolor=black><tr><td><font color=white>Student id</td><td><font color=white>Student name</td><td><font color=white>Class</td><td><font color=white>Department</td></tr>";
...
$p=mysql_query("select stud.sid,stud.sname,stud.class,dept.d_name from registration,stud,sports,dept where stud.sid=registration.sid and sports.sno=registration.sno and dept.dno=stud.dno and sports.sp_name='Athletics';");
if(!$p)
echo mysql_error();
else
echo "<table border=1 bgcolor=black><tr><td><font color=white>Student id</td><td><font color=white>Student name</td><td><font color=white>Class</td><td><font color=white>Department</td></tr>";
...
$p=mysql_query("select stud.sid,stud.sname,stud.class,dept.d_name from registration,stud,sports,dept where stud.sid=registration.sid and sports.sno=registration.sno and dept.dno=stud.dno and sports.sp_name='Boxing';");
if(!$p)
echo mysql_error();
else
echo "<table border=1 bgcolor=black><tr><td><font color=white>Student id</td><td><font color=white>Student name</td><td><font color=white>Class</td><td><font color=white>Department</td></tr>";
...
$p=mysql_query("select stud.sid,stud.sname,stud.class,dept.d_name from registration,stud,sports,dept where stud.sid=registration.sid and sports.sno=registration.sno and dept.dno=stud.dno and sports.sp_name='Shot put';");
if(!$p)
echo mysql_error();
else
echo "<table border=1 bgcolor=black><tr><td><font color=white>Student id</td><td><font color=white>Student name</td><td><font color=white>Class</td><td><font color=white>Department</td></tr>";
